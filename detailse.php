...
if ($_SERVER['REQUEST_METHOD'] == 'POST'  && isset($_POST['submit'])) {
    ...
    $addcard  = $ct->addtocard($quantity,$id);
  }
?>
<?php
...
?>
                    ...
                    <div class="media">
                        <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                            <li><img src="admin/<?php echo $result['image'];?>" alt="" width="500" height="500"></li>
                    ...
                    <div class="product-attribute">
                        <h3 class="title"><?php echo $result['productname'];?></h3>
                          <div class="price">
                            <ins><span class="price-amount">Price:<span class="currencySymbol"> £</span><?php echo $result['price'];?></span></ins>
                            <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del><br>
                            <ins><span class="price-amount">Category: <?php echo $result['catname'];?></span></ins><br>
                            <ins><span class="price-amount">Brand : <?php echo $result['brandname'];?></span></ins>
                        </div>
                ...
                <div class="product-related-box single-layout">
                    ...
                    <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
                        <?php 
                            ...
                            $relatedpost=$pd->getreltadedata($id);
                            if($relatedpost){
