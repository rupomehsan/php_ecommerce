                        ...
                        <section class="footer-item">
                                ...
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc"><?php echo $result['address'];?></b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-phone"></i>
                                            <b class="desc">Phone: <?php echo $result['phone'];?></b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email:  <?php echo $result['email'];?></b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-clock"></i>
                                            <b class="desc">Hours: <?php echo $result['hourse'];?></b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="biolife-social inline">
                                <?php
                                 ...
                                 $getscial = $us->getsocialdata();
                                  if ($getscial) {
                                  while ($result = $getscial->fetch_assoc()) {
                    
                                ?>
                                <ul class="socials">
                                    <li><a href="<?php echo $result['tw'];?>" title="twitter" class="socail-btn"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo $result['fb'];?>" title="facebook" class="socail-btn"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo $result['fb'];?>" title="pinterest" class="socail-btn"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo $result['yt'];?>" title="youtube" class="socail-btn"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
